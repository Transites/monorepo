...
export default {
  ...
  data: () => ({
    ...
    items: [
      {
        src: `${import.meta.env.VITE_STRAPI_BASE_URL}/uploads/capa_Cahiers_565aaebeb0.jpg`,
      ...
      {
        src: `${import.meta.env.VITE_STRAPI_BASE_URL}/uploads/Lucia_T_Osi_99e85c049d.png`,
        title: 'Lucia Tosi',
      ...
      {
        src: `${import.meta.env.VITE_STRAPI_BASE_URL}/uploads/Ignacy_Sachs_2_15742a65c7.jpeg`,
        title: 'Ignacy Sachs',
