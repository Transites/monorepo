<template>
  <div>
    ...
    <v-navigation-drawer v-model="drawer" temporary>
      <v-text-field label="Pesquisa" v-model="searchQuery"></v-text-field>
      <v-select
  ...
  methods: {
    ...
    async performAdvancedSearch() {
      const filters = {
        ...
        ...(this.selectedTags.length ? { 'tags.id_in': this.selectedTags.join(',') } : {})
      };
    ...
    navigateSearchResults(results) {
      // Navegue ou processe os resultados da pesquisa conforme necessário
