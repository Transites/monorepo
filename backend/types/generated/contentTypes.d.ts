...
export interface ApiPersonArticlePersonArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Fechamento: Attribute.Component<'other.place-and-date'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    fim: Attribute.Component<'other.place-and-date'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
